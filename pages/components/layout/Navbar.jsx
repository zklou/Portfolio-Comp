            ...
            <motion.div className='max-h-screen pt-20 text-black bg-white border-t-0 border-red-500'>
                ...
                >
                    ...
                    <div className='flex justify-between w-3/4 pb-20 m-auto mt-20 text-3xl '>
                        <motion.a 
                            variants={linkVariants}
                            href="https://www.linkedin.com/in/zhengkun-lou/" target="_blank" className=""
                        >
                            <GrLinkedinOption />
                        </motion.a>
                        <motion.a 
                            variants={linkVariants}
                            href="https://github.com/zklou" target="_blank" className=""
                        >
                            <GrGithub/>
                        </motion.a>
                        <motion.a 
                            variants={linkVariants}
                            href="https://www.instagram.com/havagr8d/" target="_blank" className=""
                        >
                            <RiInstagramFill />
                        </motion.a>
                        <motion.a 
                            variants={linkVariants}
                            href="mailto:zhengkunlou@gmail.com" target="_blank" className=""
                        >
                            <MdEmail />
                        </motion.a>
                    </div>  
