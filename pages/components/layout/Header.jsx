      ...
      <div className='fixed z-50 flex justify-between text-white bg-red-400 sm1:hidden md:block'>
        ...
        <div className='fixed right-0 flex justify-between mt-12 mr-20 border-0 border-red-500 w-fit'>
          ...
          <div className='text-sm border-0 border-green-500 ml-28'>
            <div><Link href="https://drive.google.com/file/d/1y8MTVHcVBzGro2tO-IWjytsu1rccGKVf/view?usp=sharing" target="_blank" alt="" className="hover:text-blue-400">Resume</Link></div>
            <div><Link href="https://github.com/zklou" target="_blank" rel="noreferrer" className="hover:text-blue-400">Github</Link></div>
            <div><Link href="https://www.linkedin.com/in/zhengkun-lou/" target="_blank" rel="noreferrer" className="hover:text-blue-400">LinkedIn</Link></div>
          </div>
        </div>
      </div>
      <div className=''>
