                ...
                <div className='border-0 border-red-500'>
                    ...
                    <div className='flex justify-around w-full m-auto mt-20 text-white border-0 border-red-500'>
                        <div className='flex border-0 border-red-500 xl:space-x-20 sm1:flex-col xl:flex-row sm1:space-y-2 md:space-y-8 xl:space-y-0'>
                            <a href="mailto:zhengkunlou@gmail.com" className='border-0 border-red-500'>
                            ...
                            <a href="tel:+1-416-886-0087" className='border-0 border-red-500'>    
                                <div className='flex flex-row space-x-4'>
                            ...
                            <div className='flex space-x-4 border-0 border-red-500 sm1:pt-8 md:pt-4 lg:pt-0 md:text-3xl sm1:text-3xl lg:text-2xl'>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://github.com/zklou" target="_blank" rel="noreferrer" ><FiGithub /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://www.instagram.com/havagr8d/" target="_blank" rel="noreferrer"><FiInstagram /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://www.linkedin.com/in/zhengkun-lou/" target="_blank" rel="noreferrer"><FaLinkedinIn /></a>
                                <a className='text-blue-400 rounded-full sm1:p-2 md:p-4 bg-blue-400/20' href="https://drive.google.com/file/d/1y8MTVHcVBzGro2tO-IWjytsu1rccGKVf/view?usp=sharing" target="_blank"><IoDocumentTextOutline /></a>
                            </div>
                        </div>           
                    </div>
                </div>    
